  ...
  describe('internals', () => {
    ...
    describe('getCaptionDetails', () => {
      it('should set the starting second', () => {
        ...
        const actual = module.internals.getCaptionDetails(input);
      ...
      it('should set the position', () => {
        ...
        const actual = module.internals.getCaptionDetails(input, 42);
      ...
      it('should set the url', () => {
        ...
        const actual = module.internals.getCaptionDetails(caption, 42, videoId);
      ...
      it('should return a default caption if no input caption', () => {
        const actual = module.internals.getCaptionDetails(undefined, 42, 'foo');
    ...
    describe('recordsFromVideo', () => {
      ...
      it('get one record per caption', () => {
        ...
        const actual = module.internals.recordsFromVideo(input);

        expect(actual).toHaveLength(2);
      });

      it('sets the caption details', () => {
        mockInternal('getCaptionDetails', { content: 'bar' });
        const input = {
      ...
      it('set the popularity score to each record', () => {
        mockInternal('getPopularityScore', 1234);
        const input = { video: { id: 'foo' } };
      ...
      it('set the bucketed published date  score to each record', () => {
        mockInternal('getBucketedDate', { day: 1, year: 4 });
        const input = { video: { id: 'foo' } };
    ...
    describe('getPopularityScore', () => {
      it('sums up all interactions', () => {
        ...
        const actual = module.internals.getPopularityScore(input);
    ...
    describe('getBucketedDate', () => {
      it('sums up all interactions', () => {
        ...
        const actual = module.internals.getBucketedDate(input);
    ...
    describe('enrichVideos', () => {
      ...
      it('add conference year', async () => {
        const input = [{ foo: 'bar' }];
        mockInternal('guessConferenceYear', 2018);
